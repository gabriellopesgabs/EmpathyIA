...
This guide helps you build EmpathyIA on Linux with **automatic GPU acceleration**. The build system detects your hardware and configures the best performance automatically.
...
```
src-tauri/target/release/bundle/appimage/EmpathyIA_<version>_amd64.AppImage
```
