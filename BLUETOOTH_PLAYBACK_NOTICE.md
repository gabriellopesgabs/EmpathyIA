...
When **reviewing recordings** in EmpathyIA, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **EmpathyIA records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing EmpathyIA recordings** - Use wired/speakers instead
...
### This is Not a EmpathyIA Bug

The issue is in **macOS's Bluetooth audio stack**, not in EmpathyIA's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a EmpathyIA bug. We've correctly recorded at 48kHz.
...
**A**: Yes! EmpathyIA now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: EmpathyIA v0.0.5+ on macOS
