#!/bin/bash
# GPU-accelerated development script for EmpathyIA
...
echo -e "${BLUE}🚀 EmpathyIA GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting EmpathyIA in development mode...${NC}"
echo ""
