@echo off
REM EmpathyIA Build Script for Windows
...
echo 🚀 Building EmpathyIA application...
...
echo.
echo ========================================
echo    EmpathyIA Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the EmpathyIA Tauri application for Windows.
