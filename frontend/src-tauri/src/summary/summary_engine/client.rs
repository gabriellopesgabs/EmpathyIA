...
/// High-level API to generate text using the built-in AI sidecar
///
/// # Arguments
/// * `app_data_dir` - Application data directory
/// * `model_name` - Model name to generate with
/// * `system_prompt` - System prompt
/// * `user_prompt` - User prompt
/// * `grammar` - Optional grammar string (GBNF)
/// * `grammar_root` - Optional grammar root rule name
