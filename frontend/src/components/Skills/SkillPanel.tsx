...
import { ParticipantMemoryPanel } from '@/components/Skills/ParticipantMemoryPanel';
  ...
  return (
    <aside className="skill-panel" aria-label="Painel de Skills">
      ...
      {!result && !editor && <>
        ...
        {note.external_meeting?.provider === 'microsoft' && <ParticipantMemoryPanel noteId={note.id} meeting={note.external_meeting} />}
