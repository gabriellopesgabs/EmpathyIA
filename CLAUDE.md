...
**EmpathyIA** is a privacy-first AI meeting assistant that captures, transcribes, and summarizes meetings entirely on local infrastructure. The supported application is the Tauri desktop app with a Rust core.
...
- **Production (macOS)**: `~/Library/Application Support/ai.empathy.desktop/models/`
- **Production (Windows)**: `%APPDATA%\ai.empathy.desktop\models\`
